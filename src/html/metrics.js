...
.mhead h2{margin:0}
#m-status{font-size:12px;font-weight:600;letter-spacing:.02em;padding:2px 9px;border-radius:999px;background:#1a1e25;color:#7d8794}
...
.mlbl{font-size:12px;text-transform:uppercase;letter-spacing:.07em;color:#7d8794;margin-bottom:7px}
...
.msub{font-size:12px;color:#5b6470;margin-top:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.msparkval{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:16px;font-weight:700;color:#e6e9ee}
