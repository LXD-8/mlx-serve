        ...
        VStack(alignment: .leading, spacing: 4) {
            ...
            if isExpanded {
                ...
                Button {
                    ...
                    HStack(spacing: 4) {
                        Text("GET")
                            .font(.system(size: AppTypeScale.body, weight: .bold, design: .monospaced))
                            .foregroundStyle(.green)
...
struct TerminalLogTextView: NSViewRepresentable {
    ...
    private static let textFont = NSFont.monospacedSystemFont(ofSize: AppTypeScale.body, weight: .regular)
