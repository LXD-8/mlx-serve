...
struct Model3DGenView: View {
    ...
    private var photoSection: some View {
        VStack(alignment: .leading, spacing: 6) {
            Text("Photo").font(.system(size: AppTypeScale.body, weight: .semibold))
            if let url = photoURL {
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            if showAdvanced {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("Mesh resolution").font(.system(size: AppTypeScale.body))
                    ...
                    Text("Higher = finer mesh, more memory and time.").font(.system(size: AppTypeScale.body)).foregroundStyle(.secondary)
                }
        ...
        VStack(spacing: 8) {
            ...
            HStack(spacing: 10) {
                Toggle("Animate", isOn: $turntable)
                    .toggleStyle(.switch).font(.system(size: AppTypeScale.body))
